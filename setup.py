...
data_files.append('cb-reversinglabs-tiscale-connector.spec')
data_files.append('scripts/cb-reversinglabs-tiscale-connector')
scripts = {
    'cb-reversinglabs-tiscale-connector': {
        'spec': 'cb-reversinglabs-tiscale-connector.spec',
        'dest': '/usr/share/cb/integrations/reversinglabs-tiscale/bin/'
    }
}

setup(
    name='python-cb-reversinglabs-tiscale-connector',
    version='1.0',
    packages=['cbopensource', 'cbopensource.connectors', 'cbopensource.connectors.reversinglabstiscale'],
    url='https://github.com/carbonblack/cb-reversinglabs-tiscale-connector',
    license='MIT',
    author='Reversing Labs',
    author_email='dev-support@carbonblack.com',
    description='Connector between Carbon Black and Reversing Labs',
